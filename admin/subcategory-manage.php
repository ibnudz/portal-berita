...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Proses Hapus subkategori
    if (isset($_POST['delete'])) {
        $subcategoryId = $_POST['id'];

        $result = $subcategoryObj->deleteSubcategory($subcategoryId);

        if ($result) {
            $msg = "Subkategori berhasil dihapus.";
            $subcategories = $subcategoryObj->getAllSubcategories();
        } else {
            $error = "Subkategori gagal dihapus.";
        }
    }
}
?>
                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                                ...
                                <li aria-current="page">
                                    <div class="flex items-center">
                                        ...
                                        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Kelola Subkategori</span>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                        <div class="my-4">
                            <h1 class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-white">Kelola Subkategori</h1>
                        </div>
                        <!-- success message -->
                        <?php if ($msg) { ?>
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                            ...
                                            ?>
                                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                    ...
                                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $subcategory['category_name']; ?></td>
                                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $subcategory['subcategory_name']; ?></td>
                                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $subcategory['subcategory_description']; ?></td>
                                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $subcategory['posting_date']; ?></td>
                                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $subcategory['update_date']; ?></td>
                                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                        <button type="button" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                                            ...
                                                            <a href="subcategory-edit.php?id=<?= $subcategory['id']; ?>">
                                                                Edit
                                                            </a>
                                                        </button>
                                                        ...
                                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                                            ...
                                                            <form action="" method="POST">
                                                                ...
                                                                <div class="p-6 pt-0 text-center">
                                                                    ...
                                                                    <h3 class="mt-5 mb-6 text-lg text-gray-500 dark:text-gray-400">Apa anda yakin ingin menghapus subkategori ini?
                                                                        <span class="text-lg text-red-700"><?= $subcategory['subcategory_name']; ?></span>
                                                                    </h3>
