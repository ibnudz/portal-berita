...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['add_post'])) {
        ...
        // Panggil fungsi untuk menambah post
        $result = $postObj->addPost($postTitle, $categoryId, $subcategoryId, $postDescription, $postSlug, $postImage, $postedBy, $lastUpdateBy);
                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                                ...
                                <li aria-current="page">
                                    <div class="flex items-center">
                                        ...
                                        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Tambah Berita</span>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                        <div class="my-4">
                            <h1 class="mb-10 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-white">Tambah Berita</h1>
                        </div>
                        <!-- success message -->
                        <?php if ($msg) { ?>
                        ...
                        <div class="w-full p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow dark:bg-gray-800">
                            <form class="mx-auto" method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="items-center pt-6 border-t border-gray-200 rounded-b dark:border-gray-700">
                                    <button type="submit" name="add_post" class="px-5 py-2.5 text-sm font-medium text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Tambah Berita</button>
                                </div>
                            </form>
                        </div>
                    </div>
