...
if (isset($_GET['id'])) {
    ...
    header("location: category-managed.php");
}
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['update_category'])) {
        ...
        if ($result) {
            ...
            // Update value Kategori jika berhasil
            $category['category_name'] = $categoryName;
            $category['description'] = $description;
        } else {
            $error = "Kategori gagal di update.";
        }
    }
}
?>
                    ...
                    <div class="flex flex-col items-center justify-center px-6 pt-8 mx-auto md:h-screen pt:mt-0 dark:bg-gray-900">
                        <div class="w-full max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow dark:bg-gray-800">
                            ...
                            <form class="max-w-sm mx-auto" method="POST" action="">
                                ...
                                <button type="submit" name="update_category" class="px-5 py-2.5 text-sm font-medium text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update Kategori</button>
                            </form>
                        </div>
                    </div>
