                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                                ...
                                <li aria-current="page">
                                    <div class="flex items-center">
                                        ...
                                        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Kelola Berita</span>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                        <div class="my-4">
                            <h1 class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-white">Kelola Berita</h1>
                        </div>
                        <!-- success message -->
                        <?php if ($msg) { ?>
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                            ...
                                            ?>
                                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                    ...
                                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $post['category_name']; ?></td>
                                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $post['subcategory_name']; ?></td>
                                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $post['posting_date']; ?></td>
                                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white"><?= $post['update_date']; ?></td>
                                                            ...
                                                            <form action="" method="POST">
                                                                ...
                                                                <div class="p-6 pt-0 text-center">
                                                                    ...
                                                                    <h3 class="mt-5 mb-6 text-lg text-gray-500 dark:text-gray-400">Apa anda yakin ingin menghapus subkategori ini?
                                                                        <span class="text-lg text-red-700"><?= $post['post_title']; ?></span>
                                                                    </h3>
